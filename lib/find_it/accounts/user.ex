defmodule FindIt.Accounts.User do
  use Ash.Resource,
    otp_app: :find_it,
  ...
  authentication do
    ...
    tokens do
      enabled? true
      token_resource FindIt.Accounts.Token
      signing_secret FindIt.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender FindIt.Accounts.User.Senders.SendPasswordResetEmail
